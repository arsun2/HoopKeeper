...
//        public Context context;
        private RecyclerViewClickListener mlistener;
        public MyViewHolder(TextView v, RecyclerViewClickListener listener) {
            super(v);
//            this.context = v.getContext();
    ...
    public GameHistoryAdapter(ArrayList<GameInfo> gameInfos, RecyclerViewClickListener listener) {
